...
<head>
    ...
    <title>Update Result Link | easyNaukri4u</title>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-main">
            ...
            <%
                ...
                String sql ="SELECT * FROM vacancy_result where result_id='"+result_id+"'";
            ...
            <div class="row" >
                <div class="col-md-6">
                      <div class="main-card mb-3 card">
                          <div class="card-body">
                              <form method="post" id="updateExamFrm" action="backend_page/update_vacancy_result.jsp">
