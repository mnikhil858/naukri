                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>
                                        <h2><b>Admit Card</b></h2>
                                    </div>
                                </div>  
                            </div>
                        </div>
                        <form action="backend_page/admit_card_code.jsp">
                                <div class="col-md-5" style="float: left;">
                                    <input class="form-control" type="text" name="vacancy_name" placeholder="Exam Name" required=""/>
                                </div>
                                <div class="col-md-5" style="float: left;">
                                    <input class="form-control" type="text" name="link" placeholder="Admit Card Link" required=""/>
                                </div>
                                        ...
                                        <table id="myTable" class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <form method="post" action="update_admitcard.jsp">
                                                    <td class="text-center">
                                                        <input type="hidden" name="admit_card_id" value="<%= rb.getString("admit_card_id")%>"">
                                                        <input type="submit" class="btn btn-primary btn-sm" value="Manage"/>
                                                    </td>
                                                    </form>
                                                    <form action="delete.jsp" method="post">
                                                    <td>
                                                        <input type="hidden" name="page" value="admitcard_delete"/>
                                                        <input type="hidden" name="admit_card_id" value="<%= rb.getString("admit_card_id")%>">
                                            ...
                                            %>
                                            <center><h4><b>No Admit Card Founds</b></h4></center>
                                            <%
                                                }
                                            %>
                                        </table>
