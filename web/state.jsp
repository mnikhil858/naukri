...
<head>
  ...
  <title>easyNaukri4u - LatestJobs</title>
...
<!-------------------------- JOB  ----------------------------->
  ...
  <main id="main">
    <%
        ...
        String query = "select * from latest_job_details where state= '"+state+"' ORDER By latest_job_id DESC";
        ...
        <br/><h2><%= state %> Latest Jobs</h2>
            ...
            <br><br>
              <center>
                ...
                %>
                <center><h3><b>No Vacancies Found</b></h3></center>
                <%
                    }
                %>
                  </tbody>
